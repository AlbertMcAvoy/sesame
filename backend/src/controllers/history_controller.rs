...
pub async fn create_history(
    ...
    match history_service::create_history(&state, &new_history).await {
...
pub async fn get_histories(state: web::Data<AppState>) -> impl Responder {
    match history_service::get_histories(&state).await {
...
pub async fn get_history(state: web::Data<AppState>, history_id: web::Path<i32>) -> impl Responder {
    match history_service::get_history(&state, *history_id).await {
...
pub async fn update_history(
    ...
    match history_service::update_history(&state, *history_id, &updated_history).await {
...
pub async fn delete_history(
    ...
    match history_service::delete_history(&state, *history_id).await {
